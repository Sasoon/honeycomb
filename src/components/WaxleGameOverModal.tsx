...
const WaxleGameOverModal = ({
  ...
  useEffect(() => {
    ...
    const completionKey = `waxle-daily-completed-${dailyDate}`;
          ...
          >
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <h2 id="waxle-gameover-title" className="text-xl font-semibold text-text-primary">
                  {isDailyChallenge ? 'Daily challenge complete!' : 'Game over — the board filled up!'}
                </h2>
              </div>
              ...
              {isDailyChallenge && !hasAlreadySubmitted && score < 1 && (
                <p className="text-sm text-text-secondary italic">
                  Score at least one word to join the leaderboard.
                </p>
              )}
              {isDailyChallenge && !hasAlreadySubmitted && score >= 1 && (
